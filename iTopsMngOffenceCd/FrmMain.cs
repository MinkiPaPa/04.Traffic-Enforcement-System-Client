    ...
    public partial class FrmMain : Form
    {
        ...
        private void Fn_SetCodeWithDB()
        {
            try
            {
                ...
                try
                {
                    ...
                    if (rv > 0)
                    {
                        CbbReference.DataSource = dsReference.Tables[0];

                        CbbReference.DisplayMember = "display_value";
                        CbbReference.ValueMember = "cd";

                        CbbReference.Text = null;
                    }
        ...
        private int Fn_LoadData()
        {
            ...
            try
            {
                ...
                // Data 조회
                int rv = iTopsLib.Lib.GFn_GetOffenceCodeDS(ref dsOffenceCd, false);
                ...
                if (dsOffenceCd.Tables.Count > 0)
                {
                    ...
                    try
                    {
                        DBGrid.DataSource = dsOffenceCd.Tables[0];
        ...
        private void Fn_Design()
        {
            try
            {
                ...
                DBGrid.DisplayLayout.Bands[0].Columns["offence_cd"].Hidden = false;
                DBGrid.DisplayLayout.Bands[0].Columns["reference_cd"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["reference_desc"].Hidden = false;
                DBGrid.DisplayLayout.Bands[0].Columns["legislation_group"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["relevant_legislation_cd"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["relevant_legislation_desc"].Hidden = false;
                DBGrid.DisplayLayout.Bands[0].Columns["category"].Hidden = false;

                DBGrid.DisplayLayout.Bands[0].Columns["use_yn"].Hidden = false;

                DBGrid.DisplayLayout.Bands[0].Columns["speed_limit"].Hidden = false;

                DBGrid.DisplayLayout.Bands[0].Columns["penalty_min_speed"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["penalty_max_speed"].Hidden = true;

                DBGrid.DisplayLayout.Bands[0].Columns["speed_from"].Hidden = false;
                DBGrid.DisplayLayout.Bands[0].Columns["speed_to"].Hidden = false;
                DBGrid.DisplayLayout.Bands[0].Columns["fine"].Hidden = false;
                ...
                DBGrid.DisplayLayout.Bands[0].Columns["offence_cd_org"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["reference_cd_org"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["relevant_legislation_cd_org"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["category_org"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["use_yn_org"].Hidden = true;

                DBGrid.DisplayLayout.Bands[0].Columns["speed_limit_org"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["penalty_min_speed_org"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["penalty_max_speed_org"].Hidden = true;

                DBGrid.DisplayLayout.Bands[0].Columns["speed_from_org"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["speed_to_org"].Hidden = true;
                DBGrid.DisplayLayout.Bands[0].Columns["fine_org"].Hidden = true;
                ...
                //DBGrid.DisplayLayout.Bands[0].Columns["create_dtm"].Format = "";



                // Date & time format
                //DBGrid.DisplayLayout.Bands[0].Columns["use_start_date"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.DateTime;
                //DBGrid.DisplayLayout.Bands[0].Columns["use_start_date"].Nullable = Infragistics.Win.UltraWinGrid.Nullable.Null;
                //DBGrid.DisplayLayout.Bands[0].Columns["use_start_date"].NullText = "";
                //DBGrid.DisplayLayout.Bands[0].Columns["use_start_date"].Format = "yyyy-MM-dd";
        ...
        private void Fn_SetColWidth()
        {
            try
            {
                ...
                DBGrid.DisplayLayout.Bands[0].Columns["offence_cd"].Width = 70;
                DBGrid.DisplayLayout.Bands[0].Columns["reference_cd"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["reference_desc"].Width = 250;
                DBGrid.DisplayLayout.Bands[0].Columns["legislation_group"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["relevant_legislation_cd"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["relevant_legislation_desc"].Width = 570;
                DBGrid.DisplayLayout.Bands[0].Columns["category"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["use_yn"].Width = 80;
                DBGrid.DisplayLayout.Bands[0].Columns["speed_limit"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["penalty_min_speed"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["penalty_max_speed"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["speed_from"].Width = 70;
                DBGrid.DisplayLayout.Bands[0].Columns["speed_to"].Width = 70;
                DBGrid.DisplayLayout.Bands[0].Columns["fine"].Width = 70;
                DBGrid.DisplayLayout.Bands[0].Columns["create_dtm"].Width = 130;
                DBGrid.DisplayLayout.Bands[0].Columns["create_id"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["create_nm"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["chg_dtm"].Width = 130;
                DBGrid.DisplayLayout.Bands[0].Columns["chg_id"].Width = 100;
                DBGrid.DisplayLayout.Bands[0].Columns["chg_nm"].Width = 100;

                DBGrid.DisplayLayout.Bands[0].Columns["offence_cd_org"].Width = 50;
                DBGrid.DisplayLayout.Bands[0].Columns["reference_cd_org"].Width = 50;
                DBGrid.DisplayLayout.Bands[0].Columns["relevant_legislation_cd_org"].Width = 50;
                DBGrid.DisplayLayout.Bands[0].Columns["category_org"].Width = 50;
                DBGrid.DisplayLayout.Bands[0].Columns["use_yn_org"].Width = 50;
                DBGrid.DisplayLayout.Bands[0].Columns["speed_from_org"].Width = 50;
                DBGrid.DisplayLayout.Bands[0].Columns["speed_to_org"].Width = 50;
                DBGrid.DisplayLayout.Bands[0].Columns["fine_org"].Width = 50;

                // 컬럼 제목
                DBGrid.DisplayLayout.Bands[0].Columns["sel_yn"].Header.Caption = "";
                DBGrid.DisplayLayout.Bands[0].Columns["offence_cd"].Header.Caption = "Code";
                DBGrid.DisplayLayout.Bands[0].Columns["reference_cd"].Header.Caption = "Reference";
                DBGrid.DisplayLayout.Bands[0].Columns["reference_desc"].Header.Caption = "Reference";
                DBGrid.DisplayLayout.Bands[0].Columns["legislation_group"].Header.Caption = "Legislation Group";
                DBGrid.DisplayLayout.Bands[0].Columns["relevant_legislation_cd"].Header.Caption = "Relevant Legislation";
                DBGrid.DisplayLayout.Bands[0].Columns["relevant_legislation_desc"].Header.Caption = "Relevant Legislation";
                DBGrid.DisplayLayout.Bands[0].Columns["category"].Header.Caption = "Category";
                DBGrid.DisplayLayout.Bands[0].Columns["use_yn"].Header.Caption = "Use";
                DBGrid.DisplayLayout.Bands[0].Columns["speed_limit"].Header.Caption = "Limit";
                DBGrid.DisplayLayout.Bands[0].Columns["penalty_min_speed"].Header.Caption = "Min";
                DBGrid.DisplayLayout.Bands[0].Columns["penalty_max_speed"].Header.Caption = "Max";
                DBGrid.DisplayLayout.Bands[0].Columns["speed_from"].Header.Caption = "From";
                DBGrid.DisplayLayout.Bands[0].Columns["speed_to"].Header.Caption = "To";
                DBGrid.DisplayLayout.Bands[0].Columns["fine"].Header.Caption = "Fine";
                DBGrid.DisplayLayout.Bands[0].Columns["create_dtm"].Header.Caption = "Create";
                DBGrid.DisplayLayout.Bands[0].Columns["create_id"].Header.Caption = "ID";
                DBGrid.DisplayLayout.Bands[0].Columns["create_nm"].Header.Caption = "Name";
                DBGrid.DisplayLayout.Bands[0].Columns["chg_dtm"].Header.Caption = "Change";
                DBGrid.DisplayLayout.Bands[0].Columns["chg_id"].Header.Caption = "ID";
                DBGrid.DisplayLayout.Bands[0].Columns["chg_nm"].Header.Caption = "Name";

                DBGrid.DisplayLayout.Bands[0].Columns["offence_cd_org"].Header.Caption = "offence_cd_org";
                DBGrid.DisplayLayout.Bands[0].Columns["reference_cd_org"].Header.Caption = "reference_cd_org";
                DBGrid.DisplayLayout.Bands[0].Columns["relevant_legislation_cd_org"].Header.Caption = "relevant_legislation_cd_org";
                DBGrid.DisplayLayout.Bands[0].Columns["category_org"].Header.Caption = "category_org";
                DBGrid.DisplayLayout.Bands[0].Columns["use_yn_org"].Header.Caption = "use_yn_org";
                DBGrid.DisplayLayout.Bands[0].Columns["speed_from_org"].Header.Caption = "speed_from_org";
                DBGrid.DisplayLayout.Bands[0].Columns["speed_to_org"].Header.Caption = "speed_to_org";
                DBGrid.DisplayLayout.Bands[0].Columns["fine_org"].Header.Caption = "fine_org";
        ...
        {
            txtOffenceCd.ValueChanged -= DetailItem_ValueChanged;
            CbbReference.ValueChanged -= DetailItem_ValueChanged;
            CbbLegislation.ValueChanged -= DetailItem_ValueChanged;
            txtCategory.ValueChanged -= DetailItem_ValueChanged;
            txtSpeedLimit.ValueChanged -= DetailItem_ValueChanged;
            txtMinPenaltySpeed.ValueChanged -= DetailItem_ValueChanged;
            txtMaxPenaltySpeed.ValueChanged -= DetailItem_ValueChanged;
            nedtSpeedFrom.ValueChanged -= DetailItem_ValueChanged;
            nedtSpeedTo.ValueChanged -= DetailItem_ValueChanged;
            medtFine.ValueChanged -= DetailItem_ValueChanged;
            ...
            {
                // 값 넣기
                txtOffenceCd.Text = Convert.ToString(DBGrid.Rows[index].Cells["offence_cd"].Value);
                CbbReference.Value = Convert.ToString(DBGrid.Rows[index].Cells["reference_cd"].Value);
                CbbLegislation.Value = Convert.ToString(DBGrid.Rows[index].Cells["relevant_legislation_cd"].Value);

                txtCategory.Text = Convert.ToString(DBGrid.Rows[index].Cells["category"].Value);

                txtSpeedLimit.Text = Convert.ToString(DBGrid.Rows[index].Cells["speed_limit"].Value);
                txtMinPenaltySpeed.Text = Convert.ToString(DBGrid.Rows[index].Cells["Penalty_min_speed"].Value);
                txtMaxPenaltySpeed.Text = Convert.ToString(DBGrid.Rows[index].Cells["Penalty_max_speed"].Value);
                ...
                //nedtSpeedFrom.Value = Convert.ToInt32(DBGrid.Rows[index].Cells["speed_from"].Value);
                //nedtSpeedTo.Value = Convert.ToInt32(DBGrid.Rows[index].Cells["speed_to"].Value);
                nedtSpeedFrom.Value = DBGrid.Rows[index].Cells["speed_from"].Value;
                nedtSpeedTo.Value = DBGrid.Rows[index].Cells["speed_to"].Value;

                if (DBGrid.Rows[index].Cells["fine"].Value.ToString() == "")
                    medtFine.Value = null;
                else
                    medtFine.Value = Convert.ToString(DBGrid.Rows[index].Cells["fine"].Value);

                // ValueChanged EventHandler를 같이 사용하기 위함
                txtOffenceCd.Tag = Convert.ToString(DBGrid.Rows[index].Cells["offence_cd"].Column.Index);
                CbbReference.Tag = Convert.ToString(DBGrid.Rows[index].Cells["reference_cd"].Column.Index);
                CbbLegislation.Tag = Convert.ToString(DBGrid.Rows[index].Cells["relevant_legislation_cd"].Column.Index);
                txtCategory.Tag = Convert.ToString(DBGrid.Rows[index].Cells["category"].Column.Index);

                txtSpeedLimit.Tag = Convert.ToString(DBGrid.Rows[index].Cells["speed_limit"].Column.Index);
                txtMinPenaltySpeed.Tag = Convert.ToString(DBGrid.Rows[index].Cells["penalty_min_speed"].Column.Index);
                txtMaxPenaltySpeed.Tag = Convert.ToString(DBGrid.Rows[index].Cells["penalty_max_speed"].Column.Index);
                chkUseYN.Tag = Convert.ToString(DBGrid.Rows[index].Cells["use_yn"].Column.Index);
                nedtSpeedFrom.Tag = Convert.ToString(DBGrid.Rows[index].Cells["speed_from"].Column.Index);
                nedtSpeedTo.Tag = Convert.ToString(DBGrid.Rows[index].Cells["speed_to"].Column.Index);
                medtFine.Tag = Convert.ToString(DBGrid.Rows[index].Cells["fine"].Column.Index);
        ...
        private void CbbReference_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            else if ((e.KeyChar >= ' ' && e.KeyChar <= '~'))
            {
                ...
                String strInput = CbbReference.Text + e.KeyChar;
        ...
        private int Fn_RecValidate(Infragistics.Win.UltraWinGrid.UltraGridRow Row, ref String param)
        {
            ...
            try
            {
                ...
                // Offence Code
                if (Convert.ToString(Row.Cells["offence_cd"].Value) == String.Empty)
                {
                    rv = Convert.ToInt32(Convert.ToString(Row.Cells["offence_cd"].Column.Index));
                    param = Convert.ToString(Row.Cells["offence_cd"].Column.Header.Caption).ToUpper();
                    txtOffenceCd.Focus();
                }
                // Reference Code
                else if (Convert.ToString(Row.Cells["reference_cd"].Value) == String.Empty)
                {
                    rv = Convert.ToInt32(Convert.ToString(Row.Cells["reference_cd"].Column.Index));
                    param = Convert.ToString(Row.Cells["reference_cd"].Column.Header.Caption).ToUpper();
                    CbbReference.Focus();
                }
                // relevant_legislation_cd Desc
                else if (Convert.ToString(Row.Cells["relevant_legislation_cd"].Value) == String.Empty)
                {
                    rv = Convert.ToInt32(Convert.ToString(Row.Cells["relevant_legislation_cd"].Column.Index));
                    param = Convert.ToString(Row.Cells["relevant_legislation_cd"].Column.Header.Caption).ToUpper();
                    CbbLegislation.Focus();
                }
                // txtCategory
                ...
                // nedtSpeedFrom
                else if (Convert.ToString(Row.Cells["speed_from"].Value) == String.Empty)
                {
                    rv = Convert.ToInt32(Convert.ToString(Row.Cells["speed_from"].Column.Index));
                    param = Convert.ToString(Row.Cells["speed_from"].Column.Header.Caption).ToUpper();
                    nedtSpeedFrom.Focus();
                }
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            // Validation - 범위 중복체크 
            UltraGridRow SourceRow = null;
            UltraGridRow TargetRow = null;
            bool bIsOverlap = false;
            foreach (UltraGridRow Row in DBGrid.Rows)
            {
                // 변한 것 없는 것은 Skip
                if (Convert.ToInt32(Row.Cells["rec_state"].Value) == (int)iTopsLib.RecState.NORMAL) continue;

                // 삭제된 것은 Skip
                if (Convert.ToInt32(Row.Cells["rec_state"].Value) == (int)iTopsLib.RecState.DELETED) continue;

                // 사용하지 않을건 Skip
                if ((bool)Row.Cells["use_yn"].Value != true) continue;
                ...
                int iSpeedFrom = 0;
                int iSpeedTo = 0;
                if (Row.Cells["speed_from"].Value.ToString() != "")
                    iSpeedFrom = (int)Row.Cells["speed_from"].Value;

                if (Row.Cells["speed_to"].Value.ToString() != "")
                    iSpeedTo = (int)Row.Cells["speed_to"].Value;
                ...
                for (int i = 0; i < DBGrid.Rows.Count; i++)
                {
                    ...
                    TargetRow = DBGrid.Rows[i];


                    if (Convert.ToInt32(TargetRow.Cells["rec_state"].Value) == (int)iTopsLib.RecState.DELETED) continue;  // 삭제된 것은 Skip
                    if ((bool)TargetRow.Cells["use_yn"].Value != true) continue;                                    // 사용안하는것 Skip
                    if (Convert.ToString(Row.Cells["reference_cd"].Value) != Convert.ToString(TargetRow.Cells["reference_cd"].Value)) continue;
                    if (Convert.ToString(Row.Cells["relevant_legislation_cd"].Value) != Convert.ToString(TargetRow.Cells["relevant_legislation_cd"].Value)) continue;
                    if (Convert.ToString(Row.Cells["category"].Value) != Convert.ToString(TargetRow.Cells["category"].Value)) continue;

                    int iTgtSpeedFrom = 0;
                    int iTgtSpeedTo = 0;
                    if (TargetRow.Cells["speed_from"].Value.ToString() != "")
                        iTgtSpeedFrom = (int)TargetRow.Cells["speed_from"].Value;

                    if (TargetRow.Cells["speed_to"].Value.ToString() != "")
                        iTgtSpeedTo = (int)TargetRow.Cells["speed_to"].Value;
                    ...
                    if (Row.Cells["speed_to"].Value.ToString() == "")
                    {
                        ...
                        {
                            // 
                            MessageBox.Show("Duplicate Summon Case");
                            bIsOverlap = true;
                            break;
                        }
                        else if (iSpeedFrom < iTgtSpeedTo)
                        {
                            MessageBox.Show("Overlap Speed Range");
                            bIsOverlap = true;
                            break;
                        }
                    }
                    else if (iSpeedFrom <= iTgtSpeedTo && iSpeedTo >= iTgtSpeedFrom)
                    {
                        MessageBox.Show("Overlap Speed Range");
                        bIsOverlap = true;
                        break;
            ...
            // 중복된 것을 보여 주고 수정할 수 있게 한다... 삭제된 것은 항상 숨긴다.
            if (bIsOverlap)
            {
                // Filtering 
                Fn_SetGridFiter(SourceRow, true);

                DBGrid.ActiveRow = SourceRow;
                DBGrid.Selected.Rows.Clear();
                DBGrid.Selected.Rows.Add(TargetRow);
                DBGrid.Selected.Rows.Add(SourceRow);
            ...
            try
            {
                ...
                String[] strArrOffence_cd = new String[iCnt];
                String[] strArrReference_cd = new String[iCnt];
                String[] strArrLegislation_cd = new String[iCnt];
                String[] strArrCategory = new String[iCnt];

                String[] strArrSpeed_from = new String[iCnt];
                String[] strArrSpeed_to = new String[iCnt];
                String[] strArrFine = new String[iCnt];
                String[] strArrUse_yn = new String[iCnt];

                String[] strArrOffence_cd_org = new string[iCnt];
                ...
                foreach (UltraGridRow row in DBGrid.Rows)
                {
                    ...
                    strArrOffence_cd[iPos] = Convert.ToString(row.Cells["offence_cd"].Value);
                    strArrReference_cd[iPos] = Convert.ToString(row.Cells["reference_cd"].Value);
                    strArrLegislation_cd[iPos] = Convert.ToString(row.Cells["relevant_legislation_cd"].Value);
                    strArrCategory[iPos] = Convert.ToString(row.Cells["category"].Value);

                    strArrSpeed_from[iPos] = Convert.ToString(row.Cells["speed_from"].Value);
                    strArrSpeed_to[iPos] = Convert.ToString(row.Cells["speed_to"].Value);
                    strArrFine[iPos] = Convert.ToString(row.Cells["fine"].Value);
                    strArrUse_yn[iPos] = Convert.ToString(row.Cells["use_yn"].Value);

                    strArrOffence_cd_org[iPos] = Convert.ToString(row.Cells["offence_cd_org"].Value);
                ...
                // 저장 
                int rv = iTopsLib.Lib.GFn_InsertOffencesCode(strArrOffence_cd
                                                           , strArrReference_cd
        ...
        private bool Fn_IsChangedRow(UltraGridRow row)
        {
            ...
            // 변경 사항이 없으면 Skip
            if ((Convert.ToString(row.Cells["offence_cd"].Value)                        // Offence Code
                == Convert.ToString(row.Cells["offence_cd_org"].Value)) &&
                (Convert.ToString(row.Cells["reference_cd"].Value)                      // Reference Code
                == Convert.ToString(row.Cells["reference_cd_org"].Value)) &&
                (Convert.ToString(row.Cells["relevant_legislation_cd"].Value)           // Relevant Legislation Code
                == Convert.ToString(row.Cells["relevant_legislation_cd_org"].Value)) &&
                (Convert.ToString(row.Cells["category"].Value)                          // Category
                == Convert.ToString(row.Cells["category_org"].Value)) &&
                (Convert.ToString(row.Cells["use_yn"].Value)                            // Use YN
                == Convert.ToString(row.Cells["use_yn_org"].Value)) &&
                (Convert.ToString(row.Cells["speed_from"].Value)                        // 
                == Convert.ToString(row.Cells["speed_from_org"].Value)) &&
                (Convert.ToString(row.Cells["speed_to"].Value)                          // 
                == Convert.ToString(row.Cells["speed_to_org"].Value)) &&
                (Convert.ToString(row.Cells["fine_org"].Value)                          // 
                == Convert.ToString(row.Cells["fine_org"].Value))
                ) return false;
            else return true;
        }
        ...
        private void BtnCancel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    txtOffenceCd.Value = DBGrid.ActiveRow.Cells["offence_cd_org"].Value;
                    CbbReference.Value = DBGrid.ActiveRow.Cells["reference_cd_org"].Value;
                    CbbLegislation.Value = DBGrid.ActiveRow.Cells["relevant_legislation_cd_org"].Value;
                    txtCategory.Value = DBGrid.ActiveRow.Cells["category_org"].Value;
                    chkUseYN.Checked = (bool)DBGrid.ActiveRow.Cells["use_yn_org"].Value;
                    nedtSpeedFrom.Value = DBGrid.ActiveRow.Cells["speed_from_org"].Value;
                    nedtSpeedTo.Value = DBGrid.ActiveRow.Cells["speed_to_org"].Value;
                    medtFine.Value = DBGrid.ActiveRow.Cells["fine_org"].Value;
